...
"%VENV_PYTHON%" -c "import importlib.metadata as m; print('PyInstaller:', m.version('pyinstaller')); print('prismatoid:', m.version('prismatoid')); import prism; print('prism import: OK')"
if errorlevel 1 goto :error
