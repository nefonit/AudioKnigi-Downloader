...
## Windows dependency
The Windows requirement is `prismatoid>=0.18.1,<0.19`. Build scripts upgrade requirements in the build environment and verify that the NVDA/JAWS backend API can be imported.
