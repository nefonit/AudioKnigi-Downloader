...
- **4.7.2** — maintenance hardening: typed model access, atomic JSON, disk-space preflight, async recovery scan, queue/DnD fixes, template/tray/tooltip/cache robustness.
