...
Начиная с 4.10.1 программа может воспроизводить короткие звуковые подсказки при старте скачивания, успешном завершении и ошибке. Их можно отключить, изменить громкость и проверить в **Настройки → Звуки программы**. Звуки событий используют отдельный канал и не заменяют файл во встроенном мини-плеере.
